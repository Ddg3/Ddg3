...
public class titleLevel extends GameLevel
{
    ...
    {
        nest = new Object("nest", 640, 480, "/swanNest.png", 1, 0.1f, false);
        GameManager.objects.add(nest);
        nest.setPosition(0, -7);

        swan = new Object("swan", 92, 95, "/swanRaise.png", 12, 0.05f, false);
        GameManager.objects.add(swan);
        swan.setPosition(-10, -135);

        owlGuard2 = new Object("owlGuard2", 68, 74, "/owlGuardAnim.png", 5, 0.1f, false);
        //GameManager.objects.add(owlGuard2);
        owlGuard2.setPosition(100, -100);
        owlGuard2.playTo(0, 4);

        owlGuard = new Object("owlGuard", 68, 74, "/owlGuardAnim.png", 5, 0.1f, false);
        //GameManager.objects.add(owlGuard);
        owlGuard.setPosition(-100, -100);
        owlGuard.playTo(0, 4);

        title = new Object("title", 379, 140, "/title.png", 1, 1f, false );
