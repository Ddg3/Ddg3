...
public class Object extends GameObject implements Comparable<Object>
{
    ...
    /// For CPU_Script2
    // Static?
    public static int perpendicularDistance(Object obj1, Object obj2, int angle){
        obj1_x = obj1.getPositionX();
        obj1_y = obj1.getPositionY();
        obj2_x = obj2.getPositionX();
        obj2_y = obj2.getPositionY();

        switch(angle){
            case 0:
            case -180:
            case 180:
                return Math.abs(ob1_x - obj2_x);
            break;
            case -90:
            case 90:
                return Math.abs(obj1_y - obj2_y);
            break;
            case -135:
            case 45:
                return Math.sqrt(0.5)*(obj2_x + obj2_y)
            break;
            case -45:
            case 135:
                return Math.sqrt(0.5)*(-obj2_x + obj2_y)
