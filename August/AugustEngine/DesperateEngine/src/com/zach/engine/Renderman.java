...
public class Renderman
{
    ...
    public void drawImage(Image image, int offsetX, int offsetY, int scale)
    {
        ...
        if(tempWidth + offsetX >= pWidth)
        {
            tempWidth = tempWidth - (tempWidth + offsetX - pWidth);
        }
        if(tempHeight + offsetY >= pHeight)
        {
            tempHeight = tempHeight - (tempHeight + offsetY - pHeight);
        }
    ...
    public void drawImageTile(ImageTile image, int offsetX, int offsetY, int frameX, int frameY, int scale)
    {
        ...
        //Do not render
        if(offsetX < -image.getframeWidth())
        {
            return;
        }
        if(offsetY < -image.getframeHeight())
        {
            return;
        }
        if(offsetX >= pWidth)
